    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <Link href="/login" className="px-4 py-2 text-gray-700 font-medium hover:text-gray-900 transition">Anmelden</Link>
            <Link href="/registrieren" className="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition">Kostenlos starten</Link>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <div className="inline-flex flex-col items-center gap-2">
          <Link href="/registrieren" className="inline-block px-8 py-4 bg-blue-600 text-white text-lg font-semibold rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-500/20">
            Jetzt kostenlos testen →
          </Link>
          <span className="text-sm text-gray-400">14 Tage gratis · Keine Kreditkarte nötig</span>
        </div>
