      ...
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          ...
          <div className="space-y-2 text-sm text-gray-500">
            <div className="flex justify-between"><span>Version</span><span className="font-mono text-gray-700">1.0.0</span></div>
            <div className="flex justify-between"><span>Datenbank</span><span className="text-green-600 font-medium">● Verbunden</span></div>
            <div className="flex justify-between"><span>Region</span><span className="text-gray-700">EU Frankfurt</span></div>
          </div>
        </div>
