...
const ICONS = {
  ...
  dispatch:   'M9 4.5v15m6-15v15m-10.875 0h15.75c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H4.125C3.504 4.5 3 5.004 3 5.625v12.75c0 .621.504 1.125 1.125 1.125z',
...
const navLinks = [
  ...
  { href: '/dashboard/disposition',            label: 'Disposition',    iconId: 'dispatch',   feature: null, minRole: null,
    children: [
      ...
      { href: '/dashboard/disposition/wochenplanung',      label: 'Wochenplanung' },
      { href: '/dashboard/disposition/mitarbeiterplanung', label: 'Mitarbeiterplanung' },
      { href: '/dashboard/disposition/fahrzeugplanung',    label: 'Fahrzeugplanung' },
      { href: '/dashboard/disposition/notdienstplanung',   label: 'Notdienstplanung' },
      { href: '/dashboard/disposition/routenplanung',      label: 'Routenplanung & Live-Status' },
    ],
  },
