...
const MODULE = {
  tagesplanung: {
    titel:        'Tagesplanung',
    beschreibung: 'Plane alle heutigen Einsätze øbersichtlich nach Uhrzeit. Behalte den Überblick über laufende und anstehende Einsätze des Tages.',
...
/* ════════════════════════════════════════════════════════════════
   MODUL-KARTE (wiederverwendbare Weiterleitungskarte)
════════════════════════════════════════════════════════════════ */
...
function ModulKarte({ tabId, router }) {
  ...
  return (
    <div className="max-w-lg">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 flex flex-col items-center text-center gap-5">
        {/* Icon */}
        ...
        <button
          ...
          className={`inline-flex items-center gap-2 px-5 py-3 text-white rounded-xl text-sm font-semibold transition min-h-[48px] ${m.btnColor}`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
