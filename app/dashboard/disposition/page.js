...
const MODULE = {
  ...
  wochenplanung: {
    ...
    btnColor:     'bg-indigo-600 hover:bg-indigo-700 focus-visible:ring-indigo-500',
    icon: 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5',
  },
  mitarbeiter: {
    ...
    btnColor:     'bg-purple-600 hover:bg-purple-700 focus-visible:ring-purple-500',
  ...
  fahrzeuge: {
    ...
    btnColor:     'bg-amber-600 hover:bg-amber-700 focus-visible:ring-amber-500',
    ...
    <div className="max-w-lg">
      <Card className="p-8 flex flex-col items-center text-center gap-5">
        ...
        <button
          ...
          className={`inline-flex items-center gap-2 px-5 py-2.5 min-h-[44px] text-white rounded-xl text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${m.btnColor}`}
        >
