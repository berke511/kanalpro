...
export default function Einsatzplanung() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Auftragskalender & Tagesplanung</p>
          </div>
        </div>
        <Link
          href="/dashboard/auftraege/erstellen"
      ...
      {laden ? (
        <div className="text-gray-400 py-16 text-center text-sm">Wird geladen…</div>
      ) : (
        <>
