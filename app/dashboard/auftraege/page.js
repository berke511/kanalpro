...
───────────────────────────────────────────────────────────── */
const STATUS_CFG = {
  'offen':          { label: 'Offen',          bg: 'bg-blue-50',   text: 'text-blue-700',   dot: 'bg-blue-500',   border: 'border-blue-100'  },
  'Neu':            { label: 'Neu',             bg: 'bg-blue-50',   text: 'text-blue-700',   dot: 'bg-blue-500',   border: 'border-blue-100'  },
  'Geplant':        { label: 'Geplant',         bg: 'bg-yellow-50', text: 'text-yellow-700', dot: 'bg-yellow-400', border: 'border-yellow-100' },
  'in_bearbeitung': { label: 'In Bearbeitung',  bg: 'bg-teal-50',   text: 'text-teal-700',   dot: 'bg-teal-500',   border: 'border-teal-100'   },
  'Zugewiesen':     { label: 'Zugewiesen',      bg: 'bg-teal-50',   text: 'text-teal-700',   dot: 'bg-teal-500',   border: 'border-teal-100'   },
  'Unterwegs':      { label: 'Unterwegs',       bg: 'bg-orange-50', text: 'text-orange-700', dot: 'bg-orange-400', border: 'border-orange-100' },
  'Vor Ort':        { label: 'Vor Ort',         bg: 'bg-sky-50',    text: 'text-sky-700',    dot: 'bg-sky-400',    border: 'border-sky-100'    },
  'In Arbeit':      { label: 'In Arbeit',       bg: 'bg-amber-50',  text: 'text-amber-800',  dot: 'bg-amber-600',  border: 'border-amber-100'  },
  'Wartend':        { label: 'Wartend',         bg: 'bg-gray-100',  text: 'text-gray-500',   dot: 'bg-gray-400',   border: 'border-gray-200'   },
  'abgeschlossen':  { label: 'Abgeschlossen',   bg: 'bg-green-50',  text: 'text-green-700',  dot: 'bg-green-500',  border: 'border-green-100'  },
  'Abgeschlossen':  { label: 'Abgeschlossen',   bg: 'bg-green-50',  text: 'text-green-700',  dot: 'bg-green-500',  border: 'border-green-100'  },
  'Storniert':      { label: 'Storniert',       bg: 'bg-red-50',    text: 'text-red-600',    dot: 'bg-red-400',    border: 'border-red-100'    },
};
...
const STATUS_TABS = [
  'Alle', 'offen', 'Geplant', 'in_bearbeitung', 'Unterwegs',
  'Vor Ort', 'In Arbeit', 'Wartend', 'abgeschlossen', 'Storniert',
];

// Rollen-Architektur: Nur diese Rollen sehen alle Aufträge.
// Techniker-Filter wird in Sprint 2 gegen currentUser.rolle geprüft.
...
function StatusBadge({ status }) {
  const c = STATUS_CFG[status] ?? STATUS_CFG['offen'];
  return (
...
/* ─────────────────────────────────────────────────────────────
   Helfer: Kundennamen aus Join-Objekt lesen
───────────────────────────────────────────────────────────── */
  ...
  useEffect(() => {
    async function laden() {
      try {
        ...
        // Rollen-Architektur Sprint 2:
        // const nurEigene = !ROLLEN_ALLE_AUFTRAEGE.includes(member.rolle);
        ...
        // Sprint 2: if (nurEigene) query = query.eq('mitarbeiter_id', member.user_id);
