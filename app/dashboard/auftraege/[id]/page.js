...
const RESSOURCE_STATUS = {
  verfuegbar: { label: 'VerfÃÂ¼gbar',   dot: 'bg-green-500'  },
...
const AUFTRAG_TABS = [
  { id: 'uebersicht',    label: 'ÃÂbersicht'            },
...
const WORKFLOW_SCHRITTE = [
  ...
  { key: 'abschluss',     label: 'Auftrag abschlieÃÂen',  kurz: 'Abschluss'   },
];
...
function kundeAnzeigeName(k) {
  if (!k) return 'Ã¢ÂÂ';
  return k.kundentyp === 'firma' ? (k.firmenname ?? k.name ?? 'Ã¢ÂÂ') : (k.name ?? 'Ã¢ÂÂ');
}
...
function minZuHM(min) {
  if (min == null || isNaN(min)) return 'Ã¢ÂÂ';
...
function InfoZeile({ label, value, fullWidth = false }) {
  return (
    <div className={fullWidth ? 'col-span-2' : ''}>
      ...
      <p className="text-sm text-gray-900 font-medium">{value || <span className="text-gray-300 font-normal italic">Ã¢ÂÂ</span>}</p>
    </div>
  );
}
...
/* Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
   BEREICH 1 Ã¢ÂÂ AUFTRAGSINFORMATIONEN
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
...
function AuftragInfoKarte({ auftrag, rechte, onRefresh }) {
  ...
  const telefon = auftrag.kunden?.telefon ?? auftrag.telefon ?? 'Ã¢ÂÂ';
      ...
      <div className="px-5 py-5">
        {!edit ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-4">
            ...
            <InfoZeile label="PrioritÃÂ¤t"      value={auftrag.prioritaet} />
            ...
            <InfoZeile label="Einsatzort"     value={adresse || 'Ã¢ÂÂ'} fullWidth />
            <InfoZeile label="Einsatzdatum"   value={fmtDatum(auftrag.einsatzdatum)} />
            <InfoZeile label="Startzeit"      value={auftrag.startzeit ?? 'Ã¢ÂÂ'} />
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea rows={3} value={form.beschreibung} onChange={set('beschreibung')}
                placeholder="AuftragsbeschreibungÃ¢ÂÂ¦" className={`${inp()} resize-none`} />
            </div>
    ...
    <Karte>
      ...
      <div className="px-5 py-5 space-y-5">
        ...
        {maschinenList.length > 0 && (
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2.5">
              Maschinen & GerÃÂ¤te ({maschinenList.length})
            </p>
            <div className="space-y-1.5">
              {maschinenList.map(g => (
                <div key={g.id} className="flex items-center gap-2.5">
                  ...
                  {g.typ && <span className="text-xs text-gray-400">ÃÂ· {g.typ}</span>}
...
/* Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
   BEREICH 4 Ã¢ÂÂ AUFTRAGSNOTIZEN
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
        ...
        {rechte.addNotizen && (
          <div className="border-t border-gray-50 pt-4">
            <textarea
              ...
              placeholder="Notiz hinzufÃÂ¼genÃ¢ÂÂ¦"
...
/* Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
   RECHTE SPALTE Ã¢ÂÂ STATUS-KARTE
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
...
/* Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
   RECHTE SPALTE Ã¢ÂÂ NÃÂCHSTER SCHRITT (Bereich 5)
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
...
function NaechsterSchrittKarte({ auftrag, rechte, router }) {
  ...
  return (
    <Karte>
      <div className="px-5 py-5">
        <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">NÃÂ¤chster Schritt</p>
        <button
...
/* Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
   RECHTE SPALTE Ã¢ÂÂ AKTIVITÃÂTSCHRONIK
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
  ...
  return (
    <Karte>
      <KarteHeader
        ...
        title="AktivitÃÂ¤tschronik"
      />
      <div className="px-5 py-5">
        {aktivitaeten.length === 0 ? (
          <div className="text-center py-6 space-y-1">
            <p className="text-sm font-medium text-gray-500">Noch keine AktivitÃÂ¤ten vorhanden</p>
            <p className="text-xs text-gray-400">FÃÂ¼r diesen Auftrag wurden bisher keine AktivitÃÂ¤ten protokolliert.</p>
          </div>
        ) : (
              ...
              <div key={e.id} className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-gray-400 mt-0.5">
                    {fmtDatum(e.erstellt_am)} ÃÂ· {fmtZeit(e.erstellt_am)}
                  </p>
                </div>
              </div>
            ))}
...
function EinsatzSummaryKarte({ dok, material, fotos, auftragId, router }) {
      ...
      <div className="max-w-lg">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex flex-col items-center text-center gap-5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Der Techniker hat fÃÂ¼r diesen Auftrag noch keine Dokumentation erfasst.</p>
          </div>
          <button
  ...
  /* Ã¢ÂÂÃ¢ÂÂ Berechnungen Ã¢ÂÂÃ¢ÂÂ */
  ...
  function ZeitZeile({ label, iso }) {
    if (!iso) return <InfoZeile label={label} value="Ã¢ÂÂ" />;
  ...
  return (
    <div className="space-y-5 max-w-3xl">
      ...
      {/* 2 Ã¢ÂÂ ZeitÃÂ¼bersicht */}
      <Karte>
        <KarteHeader
          icon="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"
          title="ZeitÃÂ¼bersicht"
          badgeVariant="blue"
        />
      ...
      {/* 3 Ã¢ÂÂ TÃÂ¤tigkeiten */}
      {(dok.taetigkeiten || dok.schaden || dok.massnahmen || dok.empfehlung) && (
        <Karte>
          <KarteHeader
            icon="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"
            title="TÃÂ¤tigkeiten"
            badgeVariant="blue"
          />
          <div className="px-5 py-5 space-y-4">
            {dok.taetigkeiten && (
              <div>
                <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider mb-1">DurchgefÃÂ¼hrte Arbeiten</p>
            ...
            {dok.massnahmen && (
              <div>
                <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider mb-1">DurchgefÃÂ¼hrte MaÃÂnahmen</p>
      ...
      <div className="pt-1">
        <button
          ...
          VollstÃÂ¤ndige Dokumentation ÃÂ¶ffnen
        </button>
      </div>
...
const RECHNUNG_STATUS_CFG = {
  ...
  'ÃÂberfÃÂ¤llig':{ bg: 'bg-red-50',     text: 'text-red-700',    dot: 'bg-red-500'    },
...
function AbschlussTabKarte({ auftrag, rechnungen, auftragId, router }) {
  ...
  /* Ã¢ÂÂÃ¢ÂÂ Empty State: noch nicht abgeschlossen und keine Rechnung Ã¢ÂÂÃ¢ÂÂ */
      ...
      <div className="max-w-lg">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex flex-col items-center text-center gap-5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">PrÃÂ¼fe die Dokumentation und schlieÃÂe den Auftrag ab.</p>
          </div>
          <button
  ...
  return (
    <div className="space-y-5 max-w-2xl">
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Abschluss-Status Ã¢ÂÂÃ¢ÂÂ */}
      <Karte titel="Abschluss-Status">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            <p className="text-xs text-gray-400 uppercase tracking-wide font-medium">Freigabe fÃÂ¼r Rechnung</p>
            {freigegeben ? (
          ...
          {auftrag?.rueckgabe_grund && (
            <div className="sm:col-span-2 space-y-1">
              <p className="text-xs text-gray-400 uppercase tracking-wide font-medium">RÃÂ¼ckgabegrund</p>
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Rechnungen Ã¢ÂÂÃ¢ÂÂ */}
      {rechnungen.length > 0 && (
                ...
                <div
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <p className="text-xs text-gray-400">
                      {r.bezahlt_am ? `Bezahlt ${fmtDatum(r.bezahlt_am)}` : r.faellig_am ? `FÃÂ¤llig ${fmtDatum(r.faellig_am)}` : fmtDatum(r.erstellt_am)}
                    </p>
                  </div>
                </div>
              );
      ...
      {rechnungen.length === 0 && abgeschlossen && (
        <Karte titel="Rechnungen">
          <div className="text-center py-6 space-y-3">
            <p className="text-sm text-gray-400">Noch keine Rechnung fÃÂ¼r diesen Auftrag erstellt.</p>
            <button
              onClick={() => router.push(`/dashboard/rechnungen/neu?auftrag_id=${auftragId}`)}
...
export default function AuftragBearbeiten() {
  ...
  /* Ã¢ÂÂÃ¢ÂÂ States Ã¢ÂÂÃ¢ÂÂ */
  ...
  if (zustand === 'forbidden') return (
    <FehlerKarte
      ...
      titel="Kein Zugriff"
      text="Du hast keine Berechtigung, diesen Auftrag zu ÃÂ¶ffnen."
      button={
  ...
  if (zustand === 'not_found') return (
    <FehlerKarte
      ...
      text="Dieser Auftrag existiert nicht oder wurde gelÃÂ¶scht."
      button={
        <button onClick={() => router.push('/dashboard/auftraege')}
          className="px-4 py-2 bg-blue-600 text-white rounded-xl text-sm font-semibold hover:bg-blue-700 transition">
          ZurÃÂ¼ck zur ÃÂbersicht
  ...
  return (
    <div className="space-y-5 max-w-6xl pb-10">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-400 mt-0.5 truncate">
            {[auftrag.typ, kname, fmtDatum(auftrag.einsatzdatum)].filter(Boolean).join(' ÃÂ· ')}
          </p>
        </div>
        {/* Header-Aktionen */}
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Workflow-Leiste (Bereich 3) Ã¢ÂÂÃ¢ÂÂ */}
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Tab: ÃÂbersicht (bestehendes 2-Spalten-Layout) Ã¢ÂÂÃ¢ÂÂ */}
      {auftragTab === 'uebersicht' && (
        <div className="space-y-5">
          {/* Ã¢ÂÂÃ¢ÂÂ Auftragszusammenfassung Ã¢ÂÂÃ¢ÂÂ */}
          {(() => {
            const sumChecks = [
          ...
          {(() => {
            ...
            let step = null;
            if (!hatPlanung) {
              step = { title: 'Planung erforderlich', href: `/dashboard/auftraege/planen?id=${auftrag?.id}`, btnLabel: 'Planung Ã¶ffnen' };
            } else if (!hatRessourcen) {
              step = { title: 'Ressourcen zuweisen', href: `/dashboard/auftraege/zuweisung?id=${auftrag?.id}`, btnLabel: 'Ressourcen Ã¶ffnen' };
            } else if (!hatDok) {
              step = { title: 'Einsatz dokumentieren', href: `/dashboard/auftraege/einsatzbericht?id=${auftrag?.id}`, btnLabel: 'Einsatzbericht Ã¶ffnen' };
                ...
                <div className="px-5 py-5">
                  {step ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-gray-800">Auftrag vollstÃ¤ndig abgeschlossen</p>
                        <p className="text-sm text-gray-400 mt-0.5">FÃ¼r diesen Auftrag sind aktuell keine weiteren Schritte erforderlich.</p>
                      </div>
                    </div>
                  )}
                </div>
          ...
          <div className="space-y-5">
            ...
            {/* AktivitÃÂ¤tschronik (vorbereitet) */}
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Tab: Planung Ã¢ÂÂÃ¢ÂÂ */}
      {auftragTab === 'planung' && (
        <div className="max-w-lg">
          <Karte>
            <KarteHeader
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Tab: Ressourcen Ã¢ÂÂÃ¢ÂÂ */}
                ...
                <div className="px-5 py-5 space-y-5">
                  {!hatDaten ? (
                    <div className="text-center py-6">
                      ...
                      <p className="text-sm text-gray-400">FÃÂ¼r diesen Auftrag wurden noch keine Mitarbeiter, Fahrzeuge oder GerÃÂ¤te eingeteilt.</p>
                    </div>
                  ) : (
                    <>
                      {/* Mitarbeiter */}
...
{/* Ã¢ÂÂÃ¢ÂÂ Tab: Einsatz & Dokumentation Ã¢ÂÂÃ¢ÂÂ */}
      {auftragTab === 'einsatz' && (
        <div className="space-y-4">
          <Karte>
            ...
            <div className="px-5 py-5">
              {!einsatzDok ? (
                <div className="text-center py-8 space-y-3">
                  ...
                  <p className="text-xs text-gray-400">FÃÂ¼r diesen Auftrag wurde noch kein Einsatz begonnen.</p>
                  <button
          ...
          {einsatzDok && (
            <Karte>
              <KarteHeader icon="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" title="ZeitÃÂ¼bersicht" />
              <div className="px-5 py-5 divide-y divide-gray-50">
                {[['Einsatz gestartet',einsatzDok.unterwegs_at],['Ankunft beim Kunden',einsatzDok.vor_ort_at],['Arbeitsbeginn',einsatzDok.arbeit_begonnen_at],['Arbeitsende',einsatzDok.arbeit_beendet_at]].filter(([,v])=>v).map(([l,v])=>(
                  <div key={l} className="flex justify-between items-center text-sm py-2">
                    ...
                    <span className="font-medium text-gray-800">{fmtDatum(v)} ÃÂ· {fmtZeit(v)}</span>
                  </div>
                ))}
          ...
          {einsatzDok && (
            <Karte>
              <KarteHeader icon="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" title="TÃÂ¤tigkeiten" />
              <div className="px-5 py-5">
                {[['DurchgefÃÂ¼hrte Arbeiten',einsatzDok.durchgefuehrte_arbeiten],['Festgestellter Schaden',einsatzDok.festgestellter_schaden],['MaÃÂnahmen',einsatzDok.massnahmen],['Empfehlung',einsatzDok.empfehlung]].filter(([,v])=>v).length===0 ? (
                  <div className="text-center py-6 space-y-1">
                    <p className="text-sm font-medium text-gray-500">Noch keine TÃÂ¤tigkeiten dokumentiert</p>
                    <p className="text-xs text-gray-400">FÃÂ¼r diesen Auftrag wurden bisher keine TÃÂ¤tigkeiten erfasst.</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {[['DurchgefÃÂ¼hrte Arbeiten',einsatzDok.durchgefuehrte_arbeiten],['Festgestellter Schaden',einsatzDok.festgestellter_schaden],['MaÃÂnahmen',einsatzDok.massnahmen],['Empfehlung',einsatzDok.empfehlung]].filter(([,v])=>v).map(([l,v])=>(
                      <div key={l}>
              ...
              <div className="px-5 py-5">
                {einsatzMat.length === 0 ? (
                  <div className="text-center py-6 space-y-2">
                    ...
                    <p className="text-xs text-gray-400">FÃÂ¼r diesen Auftrag wurde bisher kein Material dokumentiert.</p>
                    <button
                      onClick={() => router.push(`/dashboard/auftraege/einsatzbericht?id=${id}`)}
                      className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition">
                      VollstÃÂ¤ndige Dokumentation ÃÂ¶ffnen
              ...
              <div className="px-5 py-5">
                {einsatzFotos.length === 0 ? (
                  <div className="text-center py-6 space-y-2">
                    ...
                    <p className="text-xs text-gray-400">FÃÂ¼r diesen Auftrag wurden bisher keine Fotos erfasst.</p>
                    <button
                      onClick={() => router.push(`/dashboard/auftraege/einsatzbericht?id=${id}`)}
                      className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition">
                      VollstÃÂ¤ndige Dokumentation ÃÂ¶ffnen
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Tab: Abschluss Ã¢ÂÂÃ¢ÂÂ */}
      {auftragTab === 'abschluss' && (
        <div className="max-w-2xl space-y-5">
          ...
          {/* Ã¢ÂÂÃ¢ÂÂ Rechnungsstatus Ã¢ÂÂÃ¢ÂÂ */}
          {(() => {
                ...
                <div className="px-5 py-5 space-y-3">
                  {rechnung ? (
                    <>
                      ...
                      <div className="space-y-2">
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-800">{rechnung.nummer ?? 'Ã¢ÂÂ'}</p>
                        </div>
                        <div>
                    ...
                    <>
                      ...
                      <p className="text-sm text-gray-500">FÃÂ¼r diesen Auftrag wurde noch keine Rechnung erstellt.</p>
                      <button
          ...
          {/* Ã¢ÂÂÃ¢ÂÂ Abschluss-Checkliste Ã¢ÂÂÃ¢ÂÂ */}
          {(() => {
            const checks = [
              { label: 'Einsatzdokumentation vorhanden', ok: !!einsatzDok },
              { label: 'TÃÂ¤tigkeiten dokumentiert',       ok: !!(einsatzDok?.durchgefuehrte_arbeiten) },
                ...
                <div className="px-5 py-5 space-y-3">
                  ...
                  <div className="pt-2 border-t border-gray-100">
                    <p className={`text-sm font-semibold ${allOk ? 'text-green-700' : 'text-gray-500'}`}>
                      {erfuelltCount} von {checks.length} Punkten erfÃÂ¼llt
                    </p>
                  </div>
                </div>
              </Karte>
          ...
          {/* Ã¢ÂÂÃ¢ÂÂ Abschlussbewertung Ã¢ÂÂÃ¢ÂÂ */}
          {(() => {
            const bewChecks = [
              { ok: !!einsatzDok },
