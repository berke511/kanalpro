...
const SEKTIONEN = [
  ...
  {
    titel: 'Fahrzeug',
    beschreibung: 'Wähle ein verfügbares Fahrzeug für diesen Einsatz.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-blue-400">
  ...
  {
    titel: 'Geräte',
    beschreibung: 'Füge benötigte Maschinen und Geräte zum Auftrag hinzu.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-blue-400">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3">
        ...
        <p className="text-xs text-blue-700">
          Die vollständige Zuweisung mit Verfügbarkeitsprüfung und Dispositionsabgleich
