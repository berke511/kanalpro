...
export default function RechnungNeuV2Page() {
  ...
  async function handleSpeichern() {
    ...
    setSpeichern(]�Ք��(����͕����Ƞ����(��������(������مȁ��屽�����(���������͕�}����͕�%��(���������������}��聍������%��(���������չ��}��聙�ɴ��չ��%������ձ��(��������ɕ���չ�͹յ����ɕ���չ��9Ȱ(�����������մ聙�ɴ����մ�(���������������}��聙�ɴ��������������ձ��(�������������չ�͑��մ聙�ɴ������չ�͑��մ�����ձ��(���������ѕՕ�ͅ���9յ��ȡ��ɴ��ѕՕ�ͅ�褰(��������ͭ��Ѽ�9յ��ȡ��ɴ�ͭ��Ѽ�������(����������ѥ镸聙�ɴ���ѥ镸�����ձ��(����������ͥѥ�������ͥѥ�����(���������х���耝�����ɘ��(��������酡�չ���х���聙�ɴ�酡�չ���х��̰(��������(������مȁɕ̀�݅�Ё������͔��ɽ���ɕ���չ��������͕�С��屽����(����������ɕ̹��ɽȤ�ѡɽ܁ɕ̹��ɽ��(������ɽ�ѕȹ��͠�����͡���ɐ��Ƚɕ���չ������(����􁍅э�����Ȥ��(������͕����ȡ��ȹ���ͅ�����������ȁ�����M������ɸ����(������͕�M������ɸ����͔��(�����(���((��������1�������(����ɕ��ɸ��(�������A����(���������A����!�������A����Q�ѱ��I����չ�����ѕ�����A����Q�ѱ���A����!������(���������A����
��ѕ����؁�����9����ѕ�еʹ�ѕ�е�Ʌ���������ѕ�е���ѕȈ�1���и��𽑥���A����
��ѕ���(�������A����(������(���((��ɕ��ɸ��(�����A����(�������A����!������(���������A����Q�ѱ��I����չ�����ѕ�����A����Q�ѱ��(���������A�����͍ɥ�ѥ����ɕ���չ��9���A�����͍ɥ�ѥ���(�������A����!������(�������A����
��ѕ���(���������؁�����9�����������ԁ���ܴ�ᰈ�ɕ���ɽ�I����((��������������Ȁ����(�������������؁�����9���􉉜�ɕ�������ɑ�ȁ��ɑ�ȵɕ������ɽչ���������Ё��́ѕ�еʹ�ѕ�еɕ�������������𽑥��(������������((����������켨�I����չ�ͥ���ɵ�ѥ��������(�����������
�ɐ�(�������������
�ɐ�
��ѕ���(���������������؁�����9����ѕ�е�́���е͕�������ѕ�е�Ʌ���������ɍ�͔��Ʌ������ݥ������Ј�I����չ�ͥ���ɵ�ѥ����𽑥��(���������������؁�����9�����������Ј�(�����������������؁�����9����ɥ���ɥ�����̴āʹ�ɥ�����̴́����Ј�(���������������������(��������������������񱅉��������9�����1	1��I����չ�͑��մ𽱅����(�����������������������Ё����􉑅є��م�Ք�홽ɴ����յ�(������������������������
�������չ�ѥ�������(������������������������͕����������մ�����хɝ�йم�Ք��(������������������������͕�����������������������̡��хɝ�йم�Ք���Ф��(������������������������(���������������������������9�����%9AUQ��(������������������𽑥��(���������������������(��������������������񱅉��������9�����1	1��i���չ��驕�𽱅����(�����������������������Ё����􉑅є��م�Ք�홽ɴ����������(������������������������
�������չ�ѥ�������͕��������������������хɝ�йم�Ք����(���������������������������9�����%9AUQ��(������������������𽑥��(���������������������(��������������������񱅉��������9�����1	1��1����չ�͑��մ𽱅����(�����������������������Ё����􉑅є��م�Ք�홽ɴ������չ�͑��յ�(������������������������
�������չ�ѥ�������͕������������չ�͑��մ�����хɝ�йم�Ք����(���������������������������9����{INPUT} />
                  </div>
                </div>
                <div>
