...
function Table({ children, className = '', ...props }) {
  return (
    <div className={'w-full overflow-x-auto rounded-xl border border-gray-100 ' + className}>
...
function TableRow({ children, className = '', ...props }) {
  return <tr className={'transition-colors hover:bg-gray-50 ' + className} {...props}>{children}</tr>;
}
