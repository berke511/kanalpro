...
export default function Input({ label, placeholder, helperText, error, required = false, disabled = false, id, className = '', ...props }) {
  const inputBase = 'block w-full rounded-lg border px-3 py-2 text-sm shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-0';
  ...
  const disabledClass = disabled ? ' bg-gray-50 cursor-not-allowed opacity-60' : ' bg-white';
