...
export const PLANS = {
  ...
  professional: {
    ...
    features: {
      ...
      einsatzberichte: true,
      fotos: true,
      unterschriften: true,     // Kundenunterschriften
      mitarbeiter: true,
      berichte: true,
      dokumente: true,          // Dokumentenmanagement
      chat: true,               // Interner Chat
      datev: true,              // DATEV-kompatibler Export (EXTF-Format)
      zeiterfassung: true,      // Zeiterfassung
      wiederkehrend: true,      // Wiederkehrende Aufträge
      wartung: true,            // Fahrzeug- & Geräte-Wartungsintervalle
      checklisten: true,        // Checklisten
      objekte: false,
      api: false,
    },
    featureListe: [
      'Bis 20 Benutzer',
      'Unbegrenzte Fahrzeuge & Geräte',
      '50 GB Speicher',
      'Alles aus Pro',
      ...
      'Fahrzeug- & Geräte-Wartungsintervalle',
      'Checklisten',
  ...
  enterprise: {
    ...
    buchbar: true,
    zielgruppe: ['Große Unternehmen', 'Ab 20 Mitarbeiter'],
    ...
    limits: {
      ...
      geraete: Infinity,
      maschinen: Infinity,
      speicher_mb: Infinity, // Unbegrenzt
    },
    features: {
      kunden: true,
      auftraege: true,
      ...
      objekte: true,
      api: true,
      webhooks: true,        // Webhooks für externe Systeme
      sso: true,             // Single Sign-On (SAML, Azure AD, Okta)
      audit_log: true,       // Audit-Log aller Aktivitäten
      standorte: true,       // Mehrere Standorte / Niederlassungen
      subunternehmer: true,  // Subunternehmer-Zugang
      white_label: true,     // White-Label auf Berichten & Angeboten
      bi_export: true,       // BI-Export (Power BI, Tableau)
    },
    featureListe: [
      'Bis 50 Benutzer',
      'Unbegrenzte Fahrzeuge & Geräte',
