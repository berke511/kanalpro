...
export function UnscheduledOrderCard({
  ...
  return (
    <div
      className={`rounded-xl border border-border border-l-4 ${colors.border} bg-background p-3 shadow-sm transition-all duration-150 hover:-translate-y-0.5 hover:shadow-md ${
        ...
        <form action={handleSubmit} className="mt-3 space-y-2 border-t border-border pt-3">
          <div className="grid grid-cols-2 gap-2">
            <input
              ...
              name="scheduled_date"
              required
              className="rounded-lg border border-border bg-card px-2 py-1.5 text-xs outline-none transition-colors focus:border-brand focus:ring-2 focus:ring-brand/10"
            />
            <input
              type="time"
              name="start_time"
          ...
          {employees.length > 0 && (
            <select
              name="employee_ids"
              className="w-full rounded-lg border border-border bg-card px-2 py-1.5 text-xs outline-none transition-colors focus:border-brand focus:ring-2 focus:ring-brand/10"
            >
          ...
          <button
            type="submit"
            disabled={submitting}
            className="flex w-full items-center justify-center gap-1.5 rounded-lg bg-gradient-to-br from-brand to-brand-dark px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition-all hover:shadow-md disabled:opacity-60"
          >
