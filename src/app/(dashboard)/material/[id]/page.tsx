...
import { deleteMaterial, updateMaterial } from "@/app/(dashboard)/material/actions";
  ...
  return (
    <div className="mx-auto max-w-2xl p-6">
      ...
      <div className="mt-6 rounded-2xl border border-border bg-card p-6">
        <MaterialForm action={updateWithId} defaultValues={item} submitLabel="Änderungen speichern" />
      </div>
    </div>
  );
}
