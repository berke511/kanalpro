...
export default async function NeueNachrichtPage({
  ...
  return (
    <div className="mx-auto max-w-2xl p-4 sm:p-6">
      <Link href="/nachrichten" className="flex items-center gap-1.5 text-sm text-muted hover:text-foreground">
        <ArrowLeft className="h-4 w-4" />
        Zurück zu den Nachrichten
      </Link>

      <h1 className="mt-2 text-2xl font-semibold tracking-tight">Neue Nachricht</h1>
